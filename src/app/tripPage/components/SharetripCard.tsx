...
export default function ShareTripCard(){
  return (
    <div className="min-w-[320px] w-90 min-h-20 rounded-lg border-2 border-gray-300 h-32 p-4">
      ...
      <div className="w-full flex flex-row gap-6 md:gap-10 mt-4">
        ...
        <button className="px-4 py-1.5 bg-black text-white font-semibold rounded cursor-pointer">
          Copy
        </button>
      </div>
    </div>
