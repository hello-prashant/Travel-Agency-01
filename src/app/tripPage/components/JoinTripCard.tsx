  ...
  return (
    <aside className="flex justify-center border border-gray-500 rounded-lg" style={{ transform: 'translateX(30px)' }}>
      <div className="w-72 md:w-full p-5 md:p-6">
        ...
        <button className="w-full mb-3 px-4 py-2.5 bg-[#F47C7C] text-white text-sm font-semibold rounded hover:bg-[#e06d6d]">Join this trip</button>
        <button className="w-full mb-2 px-4 py-2.5 border-2 border-gray-400 rounded-md text-sm font-medium text-gray-800 flex items-center justify-center gap-2 hover:bg-gray-50">
